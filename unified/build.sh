...
cat $fileDir/adguard-mobile-spyware.txt; \
...
cat $fileDir/all-in-one-adblocklist.txt; \
...
cat $fileDir/ransomwaretracker.abuse.ch.txt; \
...
cat $fileDir/squidblacklist-dg-ads.txt; \
cat $fileDir/squidblacklist-dg-malicious.txt; \
cat $fileDir/sbc.txt; \
...
cat $fileDir/urlvir-malicious.txt; \
cat $fileDir/vokins-yhosts.txt; \
cat $fileDir/windows-spy-blocker.txt; \
cat $fileDir/winhelp2002.mvps.org.txt; \
cat $fileDir/wowdude-pornlist.txt; \
